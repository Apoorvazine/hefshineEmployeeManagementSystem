    ...
    render() { 
        ...
        <div>
            ...
            <div  align="center" className="container"  ><br/>
                                ...
                                <button className="btn btn-primary  m-5" type="submit" onClick={this.save}>    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-save" viewBox="0 0 16 16">
