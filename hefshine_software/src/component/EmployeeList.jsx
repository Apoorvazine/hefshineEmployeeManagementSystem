      ...
      render(){
        if (this.state.eid>0)
        {
                                ...
                                <tbody>
                                    {this.state.Employees.map(Employee=>
                                            <tr key={Employee.id}>
                                                ...
                                                <td><button className="btn btn-warning " onClick={()=> {this.setState({eid:Employee.empId})}}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-pencil-square" viewBox="0 0 16 16">
                            ...
                            <tbody>
                                {
                                    this.state.Employees.map(Employee=>
                                        <tr key={Employee.id}>
                                            ...
                                            <td> {Employee.mob}</td>
                                            <td> {Employee.address}</td>                       
                                            <td><button className="btn btn-danger" onClick={()=>this.deleteEmp(Employee.empId)}><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-person-x" viewBox="0 0 16 16">
            ...
            if (opstate==="error") {
                return (
                        <div align="center">
                        <img src="https://www.preemploymentassessments.com/wp-content/uploads/2020/02/home-image.png" className="mb-3 rounded mx-auto d-block" width="60%" alt="Cinque Terre">
                            </img></div>
                );
    }       
  }}    
